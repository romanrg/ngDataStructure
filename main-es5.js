...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppQeueQeueComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>qeue (does not) work!</p>\n";
    /***/
  },
  ...
  function srcAppQeueQeueComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3FldWUvcWV1ZS5jb21wb25lbnQuc2NzcyJ9 */";
    /***/
  },
  ...
  function srcAppStackStackComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".stack {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  max-width: 60rem;\n  margin: 0 auto; }\n\n.stack__header {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  letter-spacing: 0.15rem;\n  font-size: 1.1667em;\n  line-height: 1.286em;\n  margin: 1.286em 0; }\n\n.container {\n  flex-grow: 1;\n  padding: 1rem;\n  box-sizing: border-box;\n  display: flex;\n  flex-wrap: nowrap;\n  align-items: center;\n  justify-content: space-between; }\n\n.stack__structure, .stack__input, .stack__output {\n  height: 100%;\n  width: 100%; }\n\n.stack__structure, .stack__input {\n  margin-right: 2rem; }\n\n.output__item, .stack__item, .input__item {\n  padding-left: 1rem; }\n\n.output__item h4, .stack__item h4, .input__item h4 {\n    word-break: break-all;\n    display: flex;\n    align-items: center;\n    justify-content: center; }\n\n.stack__list, .output__list {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n  padding: 0;\n  list-style: none; }\n\n.input__list {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n  padding: 0;\n  list-style: none; }\n\n.input__button {\n  padding: 2rem;\n  margin: 0;\n  border: 0;\n  background: transparent;\n  text-transform: uppercase; }\n\n.input__header, .output__header, .structure__header {\n  display: flex;\n  margin: 0;\n  align-items: center;\n  justify-content: center;\n  padding: 2rem 0 0; }\n\n.wrapper {\n  padding-left: 1rem;\n  padding-right: 1rem; }\n\n.methods {\n  display: flex; }\n\n.methods__header {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin: 0; }\n\n.methods__list {\n  display: flex;\n  flex-wrap: wrap;\n  flex-grow: 1;\n  align-items: center;\n  justify-content: center;\n  padding: 0;\n  margin: 0;\n  list-style: none; }\n\n.method__button {\n  background: transparent;\n  padding: 1rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin: 0.5rem;\n  border-radius: 0.5rem;\n  border: 0;\n  box-shadow: none;\n  outline: none; }\n\n.method__button:focus, .method__button:hover {\n    cursor: pointer; }\n\n.empty {\n  transition: color 0.25s;\n  color: olivedrab; }\n\n.full {\n  transition: color 0.25s;\n  color: crimson; }\n\n.animation {\n  transform: none; }\n\n.animation-clear {\n  -webkit-animation: clear 0.3s;\n          animation: clear 0.3s; }\n\n.animation-add {\n  -webkit-animation: add 0.3s;\n          animation: add 0.3s; }\n\n.animation-move-stack {\n  -webkit-animation: moveStack 0.3s;\n          animation: moveStack 0.3s; }\n\n.animation-leave {\n  -webkit-animation: complete 0.3s;\n          animation: complete 0.3s; }\n\n@-webkit-keyframes complete {\n  from {\n    transform: translateX(0%); }\n  to {\n    transform: translateX(200%); } }\n\n@keyframes complete {\n  from {\n    transform: translateX(0%); }\n  to {\n    transform: translateX(200%); } }\n\n@-webkit-keyframes clear {\n  from {\n    transform: translateY(0%);\n    color: inherit; }\n  to {\n    transform: translateY(-200%);\n    color: transparent; } }\n\n@keyframes clear {\n  from {\n    transform: translateY(0%);\n    color: inherit; }\n  to {\n    transform: translateY(-200%);\n    color: transparent; } }\n\n@-webkit-keyframes add {\n  from {\n    transform: translateY(100%); }\n  to {\n    transform: translateY(0%); } }\n\n@keyframes add {\n  from {\n    transform: translateY(100%); }\n  to {\n    transform: translateY(0%); } }\n\n@-webkit-keyframes moveStack {\n  0% {\n    transform: translateX(-100%); }\n  100% {\n    transform: translateX(0%); } }\n\n@keyframes moveStack {\n  0% {\n    transform: translateX(-100%); }\n  100% {\n    transform: translateX(0%); } }\n\n.input, .stack__structure, .output {\n  display: flex;\n  flex-direction: column; }\n\n@media screen and (max-width: 600px) {\n  .stack__structure, .stack__input {\n    margin-right: 0; }\n  .input__button {\n    padding: 0.3rem; }\n  .output__item, .stack__item, .input__item {\n    padding-left: 0rem; }\n  .method__button {\n    padding: 0; } }\n\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(StackComponent, [{
        ...
        value: function push() {
          ...
          requestAnimationFrame(function () {
            setTimeout(function () {
              _this.stackItems[_this.stackItems.length - 1].move = false;
            }, 200);
          });
        }
      }, {
        ...
        value: function clear() {
          ...
          requestAnimationFrame(function () {
            setTimeout(function () {
              _this3.stackService.clear();

              _this3.stackItems = _this3.stackService.getItems();
              _this3.clearAnimation = false;
              _this3.peeked = _this3.stackService.peek();
            }, 200);
          });
        }
      }]);
